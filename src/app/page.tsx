    ...
    <>
      ...
      <main>
        ...
        <section className="text-center pt-20 py-32 px-2 md:px-8 flex flex-col justify-center items-center mx-auto">
          ...
          <Button className="px-7 py-6 rounded-3xl shadow-sm bg-[#0F4C69] transition delay-150 duration-300 ease-in-out hover:bg-[#296c8b] hover:scale-105"><a href="#polls-section">Tu Opinión Cuenta</a></Button>
        </section>
